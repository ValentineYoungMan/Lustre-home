        ...
        let template = `
                        <div data-pid="${productId}" class="block4-product">
                            <a href="#" class="block4-product-img ibg">
                                ...
                                <div class="block4-product-button">Дивитися товар</div>
